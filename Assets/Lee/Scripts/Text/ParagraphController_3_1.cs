...
public class ParagraphController_3_1 : MonoBehaviour
{
	[Header("Paragraph")]
	...
	// Audio
	// private AudioController_1_4 _audioController;
    private Dictionary<string, Paragraph> _exitDictionary = new Dictionary<string, Paragraph>();

	// Light
	// private LightController_1_4 _lightController;

	// Game
	private GameController_3_1 _gameController;

    private int _buttonNum;

    private void Awake()
    {
		// _audioController = FindFirstObjectByType<AudioController_1_4>();
		// _lightController = FindFirstObjectByType<LightController_1_4>();
		_gameController = FindFirstObjectByType<GameController_3_1>();
