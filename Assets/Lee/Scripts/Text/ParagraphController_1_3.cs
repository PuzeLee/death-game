...
public class ParagraphController_1_3 : MonoBehaviour
{
	[Header("Paragraph")]
	...
	// Audio
	private AudioController_1_3 _audioController;
    private Dictionary<string, Paragraph> _exitDictionary = new Dictionary<string, Paragraph>();

	// Light
	private LightController_1_3 _lightController;

	// Game
	private GameController_1_3 _gameController;

    private int _buttonNum;

    private void Awake()
    {
		_audioController = FindFirstObjectByType<AudioController_1_3>();
		_lightController = FindFirstObjectByType<LightController_1_3>();
		_gameController = FindFirstObjectByType<GameController_1_3>();
