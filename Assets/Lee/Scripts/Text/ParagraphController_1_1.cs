...
public class ParagraphController_1_1 : MonoBehaviour
{
	[Header("Paragraph")]
	...
	// Audio
	private AudioController_1_1 _audioController;
    private Dictionary<string, Paragraph> _exitDictionary = new Dictionary<string, Paragraph>();

	// Light
	// private LightController_1_1 _lightController;
    ...
    private void Awake()
    {
		_audioController = FindFirstObjectByType<AudioController_1_1>();
		// _lightController = FindFirstObjectByType<LightController_1_1>();
